...
TEST_SUITE("Testing cli::param_parser" * doctest::description("Class cli::param_parser tests")) {
    TEST_CASE("Testing the creation and preparation of the cli::param_parser class for parsing") {
        cli::param_parser cli_parser;
    ...
    TEST_CASE("Testing cli::param_parser reset() method") {
        cli::param_parser cli_parser;
    ...
    TEST_CASE("Testing cli::param_parser parse result") {
    ...
    TEST_CASE("Testing cli::param_parser parse result (default values)") {
